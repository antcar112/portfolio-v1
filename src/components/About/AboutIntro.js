...
import { SectionParagraph } from 'src/components/Text/Text'
...
const AboutIntro = () => (
  <StyledAboutIntro>
    ...
    <AboutCard className='about-text'>
      ...
      <SectionParagraph>
        I love how developing software allows me to build something new from scratch. I also enjoying the constant
        problem solving and learning.
      </SectionParagraph>
      <SectionParagraph>
        I currently live in the greater <span className='bold'>Vancouver</span> area. In my spare time, I enjoy playing
        guitar and drums, watching hockey, exploring new types of music, running and cooking.
      </SectionParagraph>
    </AboutCard>
  </StyledAboutIntro>
)
